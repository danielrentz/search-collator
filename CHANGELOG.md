...
- Fixed: Return type of `findMatches` is now an `IteratorObject<CollatorMatch>` to support [iterator helpers](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Iterator#instance_methods)
